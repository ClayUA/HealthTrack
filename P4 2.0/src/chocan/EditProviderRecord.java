...
public class EditProviderRecord 
extends JFrame 
    ...
    public void actionPerformed(ActionEvent e)
    {
        if (e.getSource() == submit) {
            if (num.getText().length() == 9 && num.getText().matches(numCheck)) {
                ...
                String number, numData, nameData, addressData, cityData, stateData, zipData;
                numData = num.getText();
...
class EditP {
	public static void main(String[] args) throws Exception {
        EditProviderRecord f = new EditProviderRecord();
	}
