...
/** 
 * AddMemberRecord class. This generates a frame where operator can input member/provider record info 
 * for the Provider terrminal's add function.
 * @author Aniyah
 */

public class AddMemberRecord 
extends JFrame 
...
class Add {
	public static void main(String[] args) throws Exception {
		AddMemberRecord f = new AddMemberRecord();
	}
